# Generated by Django 2.2.1 on 2019-05-30 19:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternativas', models.ManyToManyField(blank=True, related_name='_alternativaquestao_alternativas_+', to='questionarios.AlternativaQuestao')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.AddField(
            ...
            name='questao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alternativas', to='questionarios.Questao'),
        ),
    ]
